...
export IFLYTEK_SN=1234567890
export IFLYTEK_APPID="3180af67"
export IFLYTEK_API_KEY="2f34da499df6d46b350ec6dc23e92e21"
export IFLYTEK_API_SECRET="ZjM3ZmMyYjRiYmFiMDkwMmU0ZjQyM2Yz"
...
export GONGAN_API_USERNAME="${GONGAN_API_USERNAME:-1234567}"
export GONGAN_API_PWD_MD5="${GONGAN_API_PWD_MD5:-96e79218965eb72c92a549dd5a330112}"
...
export GONGAN_ASR_STREAMING="${GONGAN_ASR_STREAMING:-0}"
...
export FUNASR_HOST=36.103.180.159
